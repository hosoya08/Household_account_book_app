import CustomActiveShapePieChart from "./charts/ExpensePieChart"
                ...
                <div className='card'>
                    ...
                    <ul className="expense-box">
                        <li className="expense-box_content">
                            <div className="expense-data">8/30</div>
                            <div className="expense-name">スーパー</div>
                            <div className="expense-category-box">
                                <span className="expense-cat">食費</span>
                            </div>
